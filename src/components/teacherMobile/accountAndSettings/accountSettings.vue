  ...
  <div class="root" @click="closeMenu">
    ...
    <div class="main">
      ...
      <div style="height: 100%">
        ...
        <div class="white-div" @click="alterEmail(id)"><span class="span1">邮箱：</span><span class="span2">{{email}}</span><span style="float:right;font-size:3vmax;margin-right: 5%">></span></div>
        <div class="gray-div" @click="alterPassword(id)"><span class="span1">账户密码</span><span class="span2"></span><span style="float:right;font-size:3vmax;margin-right: 5%">></span></div>
